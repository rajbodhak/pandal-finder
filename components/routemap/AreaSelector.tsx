...
export const AreaSelector: React.FC<{
    ...
    return (
        <div className="mt-12 mb-14 h-screen bg-gradient-to-br from-orange-50 via-rose-50 to-pink-50 dark:from-gray-900 dark:via-orange-950 dark:to-rose-950 px-2 pt-2">
